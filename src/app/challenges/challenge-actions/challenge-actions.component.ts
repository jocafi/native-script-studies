...
export class ChallengeActionsComponent implements OnInit, OnChanges {
  // .JA. Create an output event for the external components that will instantiate this component (ns-challenge-actions)
  // See more at https://angular.io/api/core/EventEmitter
